...
FROM SMATRICPL A (NOLOCK)
 ...
 JOIN SCURSO J (NOLOCK) ON J.CODCURSO = I.CODCURSO AND J.CODTIPOCURSO = 11
...
WHERE D.TIPOCONTRATO='P' AND E.DTVENCIMENTO >= '01/01/2019' --/*B.CODPERLET = '2019/1'  AND D.TIPOCONTRATO='P' AND L.MESDECOMPETENCIA BETWEEN '01/01/2019' AND '30/06/2019' AND L.STATUSLAN NOT IN (2,3) AND*/ AND L.CODCFO <> '006747'
 ...
 ,E.PARCELA,H.IDLAN,A.IDPERLET,E.VALOR,K.CODBOLSA,E.IDPARCELA,A.CODFILIAL,D.RA,D.CODCONTRATO,L.MESDECOMPETENCIA,M.VALORBAIXA,M.VALOR,N.VALORBAIXA,E.VALOR
...
,ISNULL(( CASE WHEN STATUS_CONTRATO = 'ATIVO'  THEN ( CASE WHEN NOME_BOLSA  LIKE '%MENSALIDADE%' THEN ISNULL((TABA.VALORORIGINAL - TABA.VALORBOLSA - TABA.BOLSAS_INCONDICIONAIS),TABA.VAL_PARCELA)  ELSE CASE WHEN NOME_BOLSA LIKE '%MENSALIDADE%' AND STATUSLAN = 'ABERTO' THEN VAL_PARCELA ELSE VLR_SBLAN END END ) ELSE 0 END),0) AS FATURAMENTO
 ...
 SELECT * FROM TABC -- WHERE/* SITUACAO LIKE 'MAT%' AND*/ RA= '00005647'--'00024826' --'00024488' --'00024826'--'00005647' --AND IDPERLET =277 

  
 UNION ALL

 SELECT * FROM TABB  -- WHERE /*SITUACAO LIKE 'MAT%' AND*/ RA= '00005647'--'00024826' --'00024488' --'00024826'--'00005647' --AND IDPERLET =277 
