...
SELECT
	...
	,ISNULL(ISNULL(ISNULL(DISCAPROVADAS.CH, ZEQUIVHISTORICO.CH),ZAPROVEITA.CARGAHORARIA),0) AS CH
	...
	,CASE 
		WHEN ISNULL (ISNULL (DISCAPROVADAS.TOT_AULAS, ZEQUIVHISTORICO.TOT_AULAS),0.00001) = 0 
			THEN 0.00001 
				ELSE  ISNULL (ISNULL (DISCAPROVADAS.TOT_AULAS, ZEQUIVHISTORICO.TOT_AULAS),0.00001) END AS MYASS
	...
	,ISNULL(DISCAPROVADAS.CODEXTERNO, ZAPROVEITA.CODEXTERNO) AS CODEXTERNO
	, CASE WHEN ISNULL(DISCAPROVADAS.CODEXTERNO, ZAPROVEITA.CODEXTERNO) IN ('DPE','APE') THEN '******' ELSE
	   CASE
			WHEN
...
SELECT 
	...
	JOIN 
		SPLETIVO (NOLOCK)
			...
			AND 
				HABMATRICULA.IDHABILITACAOFILIAL =  1808 -- :idhabilitacaofilial1      
			and 
				SDISCGRADE.CODPERIODO= 2 --:CODPERIODO1
