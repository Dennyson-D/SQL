...
SELECT  DISTINCT  J.NOME AS CURSO
,A.CODTURMA
,A.RA
...
,FORMAT(N.DATABAIXA,'dd/MM/yyyy','pt-BR') AS DATABAIXA
...
WHERE D.TIPOCONTRATO <> 'A' AND L.MESDECOMPETENCIA BETWEEN /*'01/01/2019' AND '30/06/2019'*/'2019-01-01' AND '2019-06-30' AND L.STATUSLAN NOT IN (2)--AND L.IDLAN=1533062 --/*B.CODPERLET = '2019/1' L.STATUSLAN NOT IN (2,3) AND*/ AND L.CODCFO <> '006747'
 ...
 TABB AS( ---- MENSALIDADES
	...
	,ISNULL(CASE TABA.STATUSLAN  WHEN  'ACORDO' THEN 0 WHEN  'ABERTO' THEN VLR_SBLAN ELSE VALORBAIXADO END,0) AS VALORBX_SBLAN
	...
	,ISNULL( VALORORIGINAL - BOLSA_CONDICIONAL  - TABA.BOLSAS_INCONDICIONAIS,0) AS FATURAMENTO
	--,BOLSA_CONDICIONAL
	-- 859,82 - 
	  FROM TABA 
...
, ISNULL(CASE WHEN VALIDADELIMITADA = 1 THEN BOLSAS_INCONDICIONAIS ELSE BOLSA_CONDICIONAL END,0)  AS FATURAMENTO

 FROM TABA

-- WHERE  TABA.CODBOLSA IS NOT NULL --TABA.IDLAN = 1854005 --1532977 -- 1554430 --AND TABA.CODBOLSA IS NULL
--
 ),
 ...
 */
 ------------------------FATURAMENTO------------------------------------------------------------------------------------------------------------------------
                  --SELECT * FROM TABA  WHERE IDLAN=1532444 --RA='1565444'--CURSO ='ADMINISTRA«√O - BACHARELADO'
 
 SELECT * FROM TABC -- WHERE  IDLAN = 1532444
 --1539655
 --= 1541078--1540448
--1530864  --1532977 --1565444 --BOLSAS
  
 UNION ALL

 SELECT * FROM TABB --WHERE IDLAN=1532444
 --1539655
--  1541078 --1540448
 --1530864  --1532977 --1565444 -- MENSALIDADES

 ORDER BY CURSO, RA, IDLAN, NOME_BOLSA
