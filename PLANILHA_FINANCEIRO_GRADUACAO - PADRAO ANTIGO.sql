...
WHERE D.TIPOCONTRATO <> 'A' AND L.MESDECOMPETENCIA BETWEEN /*'01/01/2019' AND '30/06/2019'*/'2019-01-01' AND '2019-06-30' AND L.STATUSLAN NOT IN (2)--AND L.IDLAN=1533062 --/*B.CODPERLET = '2019/1' L.STATUSLAN NOT IN (2,3) AND*/ AND L.CODCFO <> '006747'
 ...
 TABB AS( ---- MENSALIDADES
	...
	,ISNULL(CASE TABA.STATUSLAN WHEN 'ACORDO' THEN 0 WHEN 'ABERTO' THEN 0 ELSE TABA.VALORBAIXADO END,0) AS VALORBX_SBLAN
...
, CASE WHEN VALIDADELIMITADA = 1 THEN BOLSAS_INCONDICIONAIS ELSE BOLSA_CONDICIONAL END  AS FATURAMENTO
 ...
 */
 ------------------------FATURAMENTO------------------------------------------------------------------------------------------------------------------------
                  --SELECT * FROM TABA  WHERE RA='1565444'--CURSO ='ADMINISTRA«√O - BACHARELADO'
 /*
 SELECT * FROM TABC  --WHERE  IDLAN=1530864  --1532977 --1565444 --BOLSAS
  
 UNION ALL

 SELECT * FROM TABB -- WHERE IDLAN=1530864  --1532977 --1565444 -- MENSALIDADES
