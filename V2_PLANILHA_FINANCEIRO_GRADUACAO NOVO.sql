...
,K.VALIDADELIMITADA 
  ...
  ,CONVERT(VARCHAR,L.MESDECOMPETENCIA,103) AS MESDECOMPETENCIA
...
WHERE D.TIPOCONTRATO <> 'A' AND L.MESDECOMPETENCIA BETWEEN '01/01/2019' AND '30/06/2019' AND L.STATUSLAN NOT IN (2)--AND L.IDLAN=1533062 --/*B.CODPERLET = '2019/1' L.STATUSLAN NOT IN (2,3) AND*/ AND L.CODCFO <> '006747'
